...
TARGETS="focal groovy" # "bionic xenial precise trusty" # "focal groovy bionic xenial precise trusty" # "xenial" # "xenial precise trusty" # "xenial" # "precise trusty" # "precise" # "bionic cosmic" # "precise trusty xenial" # "precise"
