...
export GITHUB_MINUS_TO_PLUS_VERSIONS="8.15+alpha 8.14+rc1 8.14+alpha 8.13+beta1 8.13+alpha 8.12+beta1 8.11+beta1 8.10+beta3 8.10+beta2 8.10+beta1 8.9+beta1 8.8+beta1 8.7+beta2 8.7+beta1"
export GITHUB_VERSIONS="8.14.0 8.13.2 8.13.1 8.13.0 8.12.2 8.12.1 8.12.0 8.11.2 8.11.1 8.11.0 8.10.2 8.10.1 8.10.0 8.9.1 8.9.0 8.8.2 8.8.1 8.8.0 8.7.2 8.7.1 8.7.0"
...
if [ -z "${NEW_PPA}" ]; then
    NEW_PPA="many-coq-versions-ocaml-4-05"
