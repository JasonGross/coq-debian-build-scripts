...
TARGETS="bionic xenial precise trusty" # "xenial" # "xenial precise trusty" # "xenial" # "precise trusty" # "precise" # "bionic cosmic" # "precise trusty xenial" # "precise"
for TARGET in $TARGETS ; do export TARGET; ./02-make-debian.sh && ./03-build-debian-only-source.sh && ./04-try-dput.sh; done # && ./bump-version.sh && git commit -am "Bump version" && git push
